...
const D& BinarySearchTree<K, D>::find(const K& key) {
...
// can refer to the TreeNode type definition that is part of BinarySearchTree.
...
// BinarySearchTree<K, D>::TreeNode*&
// That is a pointer to a BinarySearchTree<K, D>::TreeNode, returned by reference.

template <typename K, typename D>
typename BinarySearchTree<K, D>::TreeNode*& BinarySearchTree<K, D>::_find(
...
/**
* insert()
* Inserts `key` and associated `data` into the BinarySearchTree.
*/
template <typename K, typename D>
void BinarySearchTree<K, D>::insert(const K& key, const D& data) {
...
*/
template <typename K, typename D>
const D& BinarySearchTree<K, D>::remove(const K& key) {
...
template <typename K, typename D>
const D& BinarySearchTree<K, D>::_remove(TreeNode*& node) {
...
template <typename K, typename D>
typename BinarySearchTree<K, D>::TreeNode*& BinarySearchTree<K, D>::_iop_of(
  TreeNode*& cur) const {
...
template <typename K, typename D>
typename BinarySearchTree<K, D>::TreeNode*& BinarySearchTree<K, D>::_rightmost_of(
  TreeNode*& cur) const {
...
template <typename K, typename D>
typename BinarySearchTree<K, D>::TreeNode*& BinarySearchTree<K, D>::_swap_nodes(
